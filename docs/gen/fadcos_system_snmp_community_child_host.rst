:source: fadcos_system_snmp_community_child_host.py
...
Synopsis
--------
- Configure child host of SNMPv1/v2 in SNMP Page 
...
.. raw:: html
 ...
 <tr>
 <td>fadcos_system_snmp_community_child_host</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 </tr>
...
.. raw:: html
    ...
    <li> <span class="li-head">snmp_id</span> - Specify the id of the SNMP community.<span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
