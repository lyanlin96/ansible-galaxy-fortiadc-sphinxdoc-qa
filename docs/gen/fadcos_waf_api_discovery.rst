:source: fadcos_waf_api_discovery.py
...
.. raw:: html
 ...
 <tr>
 <td>fadcos_waf_api_discovery</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 </tr>
...
.. raw:: html
    ...
    <li> <span class="li-head">api_discovery</span> - Enable or disable the API Discovery configuration.<span class="li-normal">type: str</span> <span class="li-required">required: false</span> </li>
...
.. code-block:: yaml+jinja
        ...
        - name:
          ...
          gather_facts: false
          tasks:
            - name: Add waf_api_discovery
              fadcos_waf_api_discovery:
                action: add
                name: ad1
                api_discovery: enable

            - name: Add duplicate waf_api_discovery
              fadcos_waf_api_discovery:
                action: add
                name: ad1
                api_discovery: disable

            - name: edit waf_api_discovery
              fadcos_waf_api_discovery:
                action: edit
                name: ad1
                api_discovery: enable

            - name: get waf_api_discovery
              fadcos_waf_api_discovery:
                action: get
                name: ad1

            - name: delete waf_api_discovery
              fadcos_waf_api_discovery:
                action: delete
                name: ad1
